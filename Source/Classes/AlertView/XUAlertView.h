...
+ (instancetype _Nullable)alertWithIconImage:(UIImage * _Nullable)iconImage
...
/**
 完全自定义 View
 */
+ (instancetype _Nullable)alertWithCompleteCustomView:(UIView * _Nonnull)view;
...
/**
 icon 底部双按钮 AlertView attribute message
 ...
 @param confirmClick 确认按钮点击事件
 */
+ (void)showAlertWithIcon:(UIImage *_Nullable)icon title:(NSString *_Nullable)title attributeMessage:(NSAttributedString *_Nonnull)attributeMessage cancelTitle:(NSString *_Nullable)cancelTitle cancelClick:(void (^_Nullable)(void))cancelClick confirmTitle:(NSString *_Nonnull)confirmTitle confirmClick:(void (^_Nullable)(void))confirmClick;
